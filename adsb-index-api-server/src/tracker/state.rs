...
pub struct AircraftState {
    ...
    pub airborne_position_even: Option<Timestamped<cpr::Cpr>>,
    pub airborne_position_odd: Option<Timestamped<cpr::Cpr>>,
...
impl<'a> UpdateAircraftState<'a> {
    ...
    pub fn update_aircraft_identification(
        ...
        self.update_callsign(&identification.callsign);
    }
